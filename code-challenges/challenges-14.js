...
const LastWord = (str) => {
    const The_words = str.split(' ');
    return The_words[The_words.length - 1];
  }
...
const replaceWords = (str) => {
 ...
 const iIndex = The_words.indexOf('I');
    
           const amIndex = The_words.indexOf('am');
      
       const wasIndex =The_words.indexOf('was');
    
    
       if (iIndex !== -1) {
        The_words.splice(iIndex, 1, 'We');
    }
   
    if (amIndex !== -1) {
        The_words.splice(amIndex, 1, 'are');
    }
    
    if (wasIndex !== -1) {
        The_words.splice(wasIndex, 1, 'were');
    }
